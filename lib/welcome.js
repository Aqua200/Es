...
export async function before(m, { conn, participants, groupMetadata }) {
  ...
  // Encabezado y pie de mensaje fijos (sin utilizar "em")
  let top = "*╭─⫍📢⫎─╮*\n";
  let bottom = "\n*╰─⫍📢⫎─╯*";
  
  // Asegúrate de que global.db.data.chats esté definido y tenga la configuración adecuada
...
END:VCARD`
  ...
  // Manejo de salida (suponiendo que m.messageStubType === 28 indica salida)
  ...
  // Manejo de expulsión (suponiendo que m.messageStubType === 32 indica expulsión)
